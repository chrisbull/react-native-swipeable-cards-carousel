...
export default class SwipeCard extends Component {
  ...
  renderNope() {
    ...
    if (this.props.showNope) {
      ...
      return (
        <Animated.View style={[styles.nope, this.props.nopeStyle, animatedNopeStyles]}>
          {inner}
        </Animated.View>
      )
    }
  ...
  renderMaybe() {
    ...
    if (this.props.showMaybe) {
      ...
      return (
        <Animated.View style={[styles.maybe, this.props.maybeStyle, animatedMaybeStyles]}>
          {inner}
        </Animated.View>
      )
    }
  ...
  renderYup() {
    ...
    if (this.props.showYup) {
      ...
      return (
        <Animated.View style={[styles.yup, this.props.yupStyle, animatedYupStyles]}>
          {inner}
        </Animated.View>
      )
    }
